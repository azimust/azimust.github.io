...
const Contact = () => {
  ...
  return (
    <section className="contact section" id="contact">
        <h2 className="section__title">Get on touch</h2>
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">woody.azimbek@gmail.com</span>

                        <a href="mailto:woody.azimbek@gmail.com" className="contact__button">Write me{' '}
            ...
            <div className="contact__content">
                <h3 className="contact__title">Write me your messages</h3>
