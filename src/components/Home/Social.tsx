...
const Social = () => {
  return (
    <div className="home__social">
      <a href="https://www.linkedin.com/in/azimust/" className="home__social-icon" target='_blank'>
      ...
      <a href="https://www.instagram.com/azimitto/" className="home__social-icon" target='_blank'>
